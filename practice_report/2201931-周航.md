...
![png](./figures/seq2seq_transformer_49_0.png)
...
- train/loss 变化曲线
  ...
  ![tran_loss](./figures/train_loss.svg)

- train/sample_size 变化曲线
  
  ![train/sample_size](./figures/train_sample_size.svg)

- train/grad_norm 变化曲线

  ![train/grad_norm](./figures/train_grad_norm.svg)
